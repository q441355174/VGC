...
public sealed class VideoPayloadProductionCatalog
{
    public IReadOnlyList<VideoPayloadProductionItem> BuildPhase330()
    {
        ...
        [
            ...
            new("VID330-RTSP-UDP", "RTSP/UDP decode", VideoPayloadProductionStatus.SharedModelOnly, "VideoDecodePipelineRuntime", ["decode state model", "stalled/failed health projection", "synthetic frame health log"], ["real RTSP transcript", "real UDP transcript"]),
